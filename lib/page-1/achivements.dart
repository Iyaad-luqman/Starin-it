      ...
      child: Container(
        ...
        child: Column(
          ...
          children: [
            Container(
              // vector3nL (2:44)
              margin: EdgeInsets.fromLTRB(0*fem, 0*fem, 298.06*fem, 24.13*fem),
              width: 5.94*fem,
              height: 11.88*fem,
              child: Image.asset(
            ...
            Container(
              ...
              margin: EdgeInsets.fromLTRB(59*fem, 0*fem, 47*fem, 26.07*fem),
              width: double.infinity,
              child: Row(
            ...
            Container(
              // group239763pG (2:45)
              margin: EdgeInsets.fromLTRB(0*fem, 0*fem, 7*fem, 40.31*fem),
              width: 321*fem,
              decoration: BoxDecoration (
            ...
            Container(
              // group23972kTn (2:50)
              margin: EdgeInsets.fromLTRB(0*fem, 0*fem, 7*fem, 42.31*fem),
              width: 321*fem,
              decoration: BoxDecoration (
                borderRadius: BorderRadius.circular(16*fem),
              ),
            ...
            Container(
              // group23977F9e (2:55)
              margin: EdgeInsets.fromLTRB(7*fem, 0*fem, 0*fem, 41.31*fem),
              width: 321*fem,
              decoration: BoxDecoration (
                borderRadius: BorderRadius.circular(16*fem),
              ),
            ...
            Container(
              // group23973YuS (2:60)
              margin: EdgeInsets.fromLTRB(0*fem, 0*fem, 7*fem, 41.31*fem),
              width: 321*fem,
              decoration: BoxDecoration (
                borderRadius: BorderRadius.circular(16*fem),
              ),
            ...
            Container(
              // group239754Mz (2:68)
              margin: EdgeInsets.fromLTRB(84*fem, 0*fem, 79.57*fem, 36*fem),
              child: TextButton(
                onPressed: () {},
                style: TextButton.styleFrom (
                  padding: EdgeInsets.zero,
                ...
                child: Container(
                  padding: EdgeInsets.fromLTRB(25.15*fem, 12*fem, 35.2*fem, 12*fem),
                  width: double.infinity,
                  decoration: BoxDecoration (
            ...
            Container(
              // save7Ug (2:65)
              margin: EdgeInsets.fromLTRB(110*fem, 0*fem, 91*fem, 0*fem),
              child: TextButton(
                onPressed: () {},
                style: TextButton.styleFrom (
                  padding: EdgeInsets.zero,
